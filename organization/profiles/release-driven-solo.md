...
tool-pomodoro の current release-driven development で使用する Operating Model を定義します。
...
- Timer behavior and browser lifecycle semantics are product evidence, separate from static source/build checks.
